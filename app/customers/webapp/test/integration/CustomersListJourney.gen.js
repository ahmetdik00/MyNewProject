...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Check filter bar", function (Given, When, Then) {
            Then.onTheCustomersListGenerated.onFilterBar().iCheckFilterField({ property: "customerNumber" });
        });
        ...
        opaTest("Check table columns and actions", function (Given, When, Then) {
            Then.onTheCustomersListGenerated.onTable(defaultTableId).iCheckColumns(undefined, {"email":{"header":"Email"},"customerNumber":{"header":"Customer Number"},"totalPurchaseValue":{"header":"Total Purchase Value"},"totalRewardPoints":{"header":"Total Reward Points"},"totalRedeemedRewardPoints":{"header":"Total Redeemed Reward Points"}});
        });

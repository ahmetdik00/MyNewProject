...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheRedemptionsListGenerated.iSeeThisPage();
        });

        opaTest("Check filter bar", function (Given, When, Then) {
            Then.onTheRedemptionsListGenerated.onFilterBar().iCheckFilterField({ property: "customer_ID" });
        });
        ...
        //     When.onTheRedemptionsListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheRedemptionsListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheRedemptionsListGenerated.onTable(defaultTableId).iCheckRows();
        // });

        opaTest("Check table columns and actions", function (Given, When, Then) {
            Then.onTheRedemptionsListGenerated.onTable(defaultTableId).iCheckColumns(undefined, {"redeemedAmount":{"header":"Redeemed Amount"},"customer_ID":{"header":"Customer"}});
        });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheRedemptionsListGenerated.onFilterBar().iExecuteSearch();
            Then.onTheRedemptionsListGenerated.onTable(defaultTableId).iCheckRows();
            When.onTheRedemptionsListGenerated.onTable(defaultTableId).iPressRow(0);
